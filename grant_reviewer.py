...
class GrantReviewer(gl.Contract):
    ...
    via the Equivalence Principle (gl.eq_principle).
    """
    ...
    # ── Write: trigger AI review via the Equivalence Principle ──────────────
    @gl.public.write
...
This result should be perfectly parseable by a JSON parser without errors."""
    ...
    # ── Write: update scoring criteria (owner only) ──────────────────────────
    @gl.public.write
    ...
    # ── Read: total proposals submitted ──────────────────────────────────────
    @gl.public.view
